...
import static net.northern.verasm.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.northern.verasm.repository.AuthorityRepository;
...
import net.northern.verasm.service.dto.PasswordChangeDTO;
import net.northern.verasm.service.dto.UserDTO;
import net.northern.verasm.web.rest.vm.KeyAndPasswordVM;
import net.northern.verasm.web.rest.vm.ManagedUserVM;
