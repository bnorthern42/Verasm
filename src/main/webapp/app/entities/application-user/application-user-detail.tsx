    ...
    <Row>
      <Col md="8">
        <h2 data-cy="applicationUserDetailsHeading">
          <Translate contentKey="verasmApp.applicationUser.detail.title">ApplicationUser</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="mainUsername">
              <Translate contentKey="verasmApp.applicationUser.mainUsername">Main Username</Translate>
            </span>
          </dt>
