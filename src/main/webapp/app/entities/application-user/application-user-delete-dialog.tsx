...
export const ApplicationUserDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="verasmApp.applicationUser.delete.question">
        <Translate contentKey="verasmApp.applicationUser.delete.question" interpolate={{ id: applicationUserEntity.id }}>
