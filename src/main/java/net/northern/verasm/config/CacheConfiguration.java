package net.northern.verasm.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.northern.verasm.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.northern.verasm.repository.UserRepository.USERS_BY_EMAIL_CACHE);
